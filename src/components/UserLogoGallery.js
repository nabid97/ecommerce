                    ...
                    <div className="aspect-w-1 aspect-h-1 bg-gray-100">
                      <img 
                        ...
                        onError={(e) => {
                          ...
                          e.target.src = '/api/placeholder/200/200?text=Image+Error';
                        }}
                      />
                    </div>
                    <div className="p-2 bg-white">
                      <p className="text-sm font-medium truncate">{logo.config?.text || 'Untitled Logo'}</p>
                      <p className="text-xs text-gray-500">{formatDate(logo.createdAt || new Date())}</p>
                    </div>
                ...
                <div className="flex flex-col md:flex-row gap-6">
                  ...
                  <div className="md:w-2/3">
                    ...
                    <p className="text-sm text-gray-600 mb-4">
                      Created on {formatDate(selectedLogo.createdAt || new Date())}
                    </p>
