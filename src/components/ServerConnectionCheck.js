...
const ImageGenerator = () => {
  ...
  const handleConnectionChange = (connected) => {
    ...
    if (!connected && !error) {
      setError('Warning: Cannot connect to server. Logo generation may not work.');
    } else if (connected && error === 'Warning: Cannot connect to server. Logo generation may not work.') {
      setError('');
    }
  };
  ...
  const handleGenerate = async () => {
    ...
    if (!serverConnected) {
      setError('Cannot generate logo: Server is not accessible');
      return;
    }
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <ServerConnectionCheck onConnectionChange={handleConnectionChange} />
          ...
          <div className="p-4">
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                disabled={loading || !logoConfig.text.trim() || !serverConnected}
