...
import { Card, CardContent, CardImage, CardTitle, CardDescription } from './ui/card/Card';
...
interface Product {
  ...
  colors?: Array<string | { name: string; code: string; inStock?: boolean }>;
  styles?: string[];
            ...
            <CardContent>
              ...
              <div className="mt-2 flex flex-wrap gap-2">
                {(product.colors || []).map((color, index) => {
                  // Determine the color code and display name
                  const colorCode = typeof color === 'string' 
                    ? color 
                    : color.code;
                  
                  const colorName = typeof color === 'object' && color.name
                    ? color.name
