...
* Card sizing options
*/
export const cardSizes: Record<string, string> = {
  xs: 'p-2',
  sm: 'p-4',
  md: 'p-6',
  lg: 'p-8',
...
*/
export const headerStyles: Record<string, string> = {
...
*/
export const footerStyles: Record<string, string> = {
...
*/
export const contentStyles: Record<string, string> = {
  default: 'px-6 py-4',
  compact: 'px-4 py-3',
  spacious: 'px-8 py-6',
  flush: 'p-0',
...
*/
export const cardInteractions: Record<string, string> = {
