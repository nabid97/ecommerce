...
interface ClothingVisualizerProps {
  clothingType: string;
  color: string;
...
const ClothingVisualizer: React.FC<ClothingVisualizerProps> = ({ 
  clothingType, 
  color, 
  logoImage, 
  logoPosition, 
...
const getHexFromColorName = (colorName: string): string => {
    ...
    return colorMap[colorName.toLowerCase()] || (colorName.startsWith('#') ? colorName : '#FFFFFF');
};

interface LogoCoordinates {
  x: number;
  y: number;
}

const getLogoCoordinates = (position: string, width: number, height: number): LogoCoordinates => {
    const positionMap: Record<string, LogoCoordinates> = {
...
const getLogoScale = (size: string, containerWidth: number): number => {
...
const Clothing: React.FC = () => {
    ...
    const [generateVisualization, setGenerateVisualization] = useState<boolean>(false);
    ...
    const [productConfig, setProductConfig] = useState<ClothingConfig>({
    ...
    const clothingTypes: SelectOption[] = [
    ...
    const presetColors: SelectOption[] = [
    ...
    const fabricOptions: SelectOption[] = [
    ...
    const logoSizeOptions: SelectOption[] = [
    ...
    const handleConfigChange = (field: keyof ClothingConfig, value: string | number | boolean): void => {
                                ...
                                {productConfig.colorSelectionMode === 'preset' ? (
                                    ...
                                    <div className="space-y-4">
                                        <div className="flex items-center space-x-4">
                                            <input
                                                type="color"
                                                value={productConfig.customColorHex}
    ...
    <div className="relative">
        <img
            ...
            onError={(e) => {
                ...
                e.currentTarget.src = "/api/placeholder/200/200?text=Loading+Error";
