                                        ...
                                        <div className="grid grid-cols-5 gap-2">
                                            {presetColors.map(color => (
                                                <div
                                                    ...
                                                    className={`${cardInteractions.selectable} h-10 w-full rounded-full relative flex items-center justify-center ${productConfig.color === color.value ? 'ring-2 ring-blue-500' : ''}`}
                                                ...
                                                >
                                                    ...
                                                    <span className="absolute text-xs text-white font-medium opacity-0 hover:opacity-100 transition-opacity duration-200 bg-black bg-opacity-50 rounded px-1 py-0.5">{color.label}</span>
                                                </div>
                                            ))}
                                        </div>
                                        <select
